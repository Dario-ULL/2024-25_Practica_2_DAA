 ...
 * es mayor que cero. Si es así, la ejecución salta a la dirección especificada por
 ...
 * 
 * Retorna:
 *   La dirección a la que se salta si el valor es mayor que cero, o el contador incrementado.
 */
